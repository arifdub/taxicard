...
export default async function EditJobPage({
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/dashboard/dispatch" className="text-sm text-slate-400 light:text-slate-500">
          Back to jobs
        </Link>
        <h1 className="mt-3 text-2xl font-semibold text-white light:text-navy">Edit job</h1>
